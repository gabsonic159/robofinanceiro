...
# (Todo o seu código de funções, da linha 30 até a função main, permanece o mesmo)
# O código abaixo é uma cópia exata do seu, sem alterações, até chegarmos na nova função main()
