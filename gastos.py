...
def inicializar_db():
    ...
    cursor = conn.cursor()
    # Tabela de utilizadores com gamificação
    ...
    # Tabela de cartões agora com dia de fechamento
    ...
    # Tabela de transações com `id_cartao`
...
def main():
    ...
    relatorio_conv = ConversationHandler(
        entry_points=[CommandHandler('relatorio', iniciar_relatorio), MessageHandler(filters.Regex('^📊 Relatório$'), iniciar_relatorio)],
        states={
